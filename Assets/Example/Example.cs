...
public sealed class Example : MonoBehaviour
{
    ...
    //2026.09.04注释
    public static bool useMediation = false;
    ...
    public void LoadRewardAd()
    {
        ...
        Debug.Log("点击了 LoadRewardAd按钮，原生激励视频按钮");
    }
    ...
    [ContextMenu("模拟激励广告成功流程")]
    public void Mock_RewardAd_Success()
    {
        Debug.Log("[模拟广告] 加载成功");
    ...
    [ContextMenu("模拟激励广告失败(10086无填充)")]
    public void Mock_RewardAd_Fail()
    {
        OnRewardError(10086, "模拟：没有广告填充");
    }
#endif
    //原生激励视频回调
    public void OnRewardAdLoadSuccess()
    {
        Debug.Log("[模拟广告] 加载成功---OnRewardAdLoadSuccess");
    }
    public void OnRewardError(int code, string msg)
    {
        Debug.LogError("[模拟广告] 广告关闭---OnRewardError");
    }
    public void OnRewardAdShow()
    {
        Debug.Log("[模拟广告] 广告展示---OnRewardAdShow");
    }
    public void OnRewardAdReward()
    {
        Debug.Log("[模拟广告] ✅发放奖励！！业务逻辑执行点---OnRewardAdReward()");
    }
    public void OnRewardAdClose()
    {
        Debug.Log("[模拟广告] 广告关闭---OnRewardAdClose ");
